...
is speaking.
  ...
  var PASSTHROUGH_SELECTOR = "#agus-root, .page-wrapper, .text-section, .play-section";
  function setupHostClickPassthrough(root) {
  ...
  // video.ts
  var AUDIO_DESCRIPTION_SRC_LOOP_ODD = "";
  var AUDIO_DESCRIPTION_SRC_LOOP_EVEN = "";
  function audioDescriptionSrcFor(loop) {
    return loop % 2 === 1 ? AUDIO_DESCRIPTION_SRC_LOOP_ODD : AUDIO_DESCRIPTION_SRC_LOOP_EVEN;
  }
  var videoWrapper;
  var videoContainer;
  var playButton;
  var closeButton;
  var audioDescriptionEl;
  ...
  async function initVideoPlayer(root) {
    ...
    audioDescriptionEl = root.querySelector("#audio-description");
  ...
  var captions = [
    ...
    caption(11, "00:31:00 \u2014 00:31:15", {
      ...
      french: "ctt sctn a \xE9t\xE9 cvrd\xE9e",
  ...
  var customCaptions = [
    ...
    },
    {
      ...
      text: {
        ...
        french: "[l\u2019attention se d\xE9place ailleurs]",
  ...
  function initAudioDescription(root) {
    ...
    function setPlaying(next) {
      ...
      toggle.textContent = next ? "Pause audio description" : "Play audio description";
    }
    loadPart(0);
  ...
  function makeDraggableTrack(viewport, track, onChange) {
    ...
    function setOffset(px, silent = false) {
  ...
  function findClosestToCenter() {
    ...
    pickerTrackInner.querySelectorAll(".picker-item").forEach((item) => {
